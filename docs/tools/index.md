...
# [`tool-mr0sim`](mr0sim.md)

Simulation from [MRzero-Core](https://github.com/MRsources/MRzero-Core) - tried and tested and fast. This simulation is often tested and compared to measurement and might be a better ground truth than [spinsim](./spinsim.md); because of its reliance on Python and Torch the startup time of the server is quite slow.