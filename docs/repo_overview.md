...
| [![github](https://badgen.net/badge/icon/anyfield?icon=github&label)](https://github.com/mrx-org/anyfield)                     | **[Any-field Scanner](https://mrx-org.github.io/anyfield/)**: Virtual scanner interface with parameter configuration, FOV selection and simulated measurement of MRI sequences defined by [pypulseq](https://github.com/imr-framework/pypulseq) scripts. |
